...
cdef class Tree:
    ...
    def __cinit__(self, int n_features, np.ndarray[SIZE_t, ndim=1] n_classes,
        ...
        ## : self.n_classes 是一个一维数组，第i个值是 label第i个output有几个类（multioutput）
        self.n_classes = NULL
    ...
    cdef inline object _decision_path_dense(self, object X):
        ...
        ## : csr_matrix 格式, 参考wikipedia: https://en.wikipedia.org/wiki/Sparse_matrix#Compressed_sparse_row_(CSR,_CRS_or_Yale_format)
        return out
    ...
    cdef np.ndarray _get_node_ndarray(self):
        ...
        ## : 参考 numpy reference C-api : https://numpy.org/doc/stable/reference/c-api/array.html#c.PyArray_NewFromDescr
        ##  注意 NODE_DTYPE 在开头 line 70 定义
        ##  注意 在Tree 类的 property: children_left, feature, threshold... 中使用 _get_node_ndarray返回值的方法
